...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        ///[myData addSubview:self.petName];
        //[myData addSubview:self.timeBegin];
        //[myData addSubview:self.timeEnd];
        //[myData addSubview:self.petPic];
        //[myData addSubview:self.keyPic];
        //[myData addSubview:self.keyID];
        //[myData addSubview:self.notePic];
        //[myData addSubview:self.mainLabel];
        //[myData addSubview:self.medicalPic];
        //[self.contentView addSubview:myData];
...
/*-(void)customCellFields {
    
    CGSize size = self.contentView.frame.size;
    
    _backIm = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, size.width, 100)];
    _backIm.image = [UIImage imageNamed:@"custom-cell-bg"];
    _backIm.alpha = 0.3;
    [self.contentView addSubview:_backIm];
    
    UIView *myData = [[UIView alloc]initWithFrame:self.contentView.frame];
    UIView *cellBack = [[UIView alloc]initWithFrame:self.contentView.frame];
    UIImageView *backIm = [[UIImageView alloc]initWithFrame:cellBack.frame];
    backIm.image = [UIImage imageNamed:@"custom-cell-bg"];
    [self.contentView addSubview:cellBack];
    
    self.petName = [[UILabel alloc] initWithFrame:CGRectMake(120, 10, 180 , 24)];
    [self.petName setFont:[UIFont boldSystemFontOfSize:20.0]];
    [self.petName setTextColor:[UIColor orangeColor]];
    [self.contentView addSubview:_petName];
    
    self.mainLabel = [[UILabel alloc] initWithFrame:CGRectMake(120, 46, 200 , 24)];
    [self.mainLabel setFont:[UIFont boldSystemFontOfSize:12.0]];
    [self.mainLabel setTextColor:[UIColor blackColor]];
    [self.contentView addSubview:_mainLabel];
    
    self.timeBegin = [[UILabel alloc] initWithFrame:CGRectMake(120, 30, 180 , 24)];
    [self.timeBegin setFont:[UIFont boldSystemFontOfSize:12.0]];
    [self.timeBegin setTextColor:[UIColor blackColor]];
    [self.contentView addSubview:_timeBegin];
    
    self.timeEnd = [[UILabel alloc] initWithFrame:CGRectMake(180, 30, 180 , 24)];
    [self.timeEnd setFont:[UIFont boldSystemFontOfSize:12.0]];
    [self.timeEnd setTextColor:[UIColor blackColor]];
    [self.contentView addSubview:_timeEnd];
    
    self.keyID = [[UILabel alloc] initWithFrame:CGRectMake(260, 10, 60, 24)];
    [self.keyID setFont:[UIFont boldSystemFontOfSize:12.0]];
    [self.keyID setTextColor:[UIColor orangeColor]];
    [self.contentView addSubview:_keyID];
    
    UIImageView *photoFrame = [[UIImageView alloc]initWithFrame:CGRectMake(8, 4, 80, 90)];
    photoFrame.image = [UIImage imageNamed:@"photo-frame"];
    [self.contentView addSubview:photoFrame];
    
    self.petPic = [[UIImageView alloc]initWithFrame:CGRectMake(10, 6, 74, 74)];
    self.medicalPic = [[UIImageView alloc]initWithFrame:CGRectMake(90,10, 20, 20)];
    self.keyPic = [[UIImageView alloc]initWithFrame:CGRectMake(290,10, 20, 20)];
    self.notePic = [[UIImageView alloc]initWithFrame:CGRectMake(290,70, 20, 20)];
    [self.notePic setUserInteractionEnabled:YES];
    
    [self.contentView addSubview:_petPic];
    [self.contentView addSubview:_notePic];
    [self.contentView addSubview:_keyPic];
    
    UITapGestureRecognizer *singleTap =  [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(singleTapping:)];
    [singleTap setNumberOfTapsRequired:1];
    [self.notePic addGestureRecognizer:singleTap];
