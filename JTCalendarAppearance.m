...
- (void)setDefaultValues
{
    ...
    self.focusSelectedDayChangeMode = YES;
    ...
    self.menuMonthTextFont = [UIFont fontWithName:@"Lato-Light" size:18];
    self.weekDayTextFont = [UIFont fontWithName:@"Lato-Light" size:18];
    self.dayTextFont = [UIFont fontWithName:@"Lato-Light" size:18];
    ...
    self.dayBorderColor = [UIColor lightGrayColor];
